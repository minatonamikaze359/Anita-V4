...
global.anitav4 = process.env.BOT_NAME || "SASUKE_BOT";
global.ownername = process.env.OWNER_NAME || "Minato";
global.packname = process.env.PACK_NAME || "𝐐𝐔𝐄𝐄𝐍_𝐀𝐍𝐈𝐓𝐀-𝐕𝟒";
global.author = process.env.AUTHOR || "MINATO";
global.channelname = process.env.CHANNEL_NAME || "DAVID CYRIL";
